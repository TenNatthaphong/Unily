...
import { mockCurricula } from './admin-shared';
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center justify-between px-5 py-3 bg-card border-b-2 border-border shrink-0">
        <div className="flex items-center gap-3">
          <button onClick={() => navigate('/admin/curricula')} className="p-2 rounded-xl hover:bg-accent"><ChevronLeft className="w-5 h-5" /></button>
          <div>
        ...
        <button
          onClick={() => navigate(`/admin/curricula/${id}/edit`)}
