...
import { getCategoryLabel, getCategoryColor, type Course } from '../mock-data';
import { fetchAllCurriculumData } from './curriculum-api';
import { mockSectionsDetailed, type MockSection } from './admin-shared';
    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-center space-y-3">
          ...
          <button onClick={() => navigate('/admin/courses')} className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-primary text-primary-foreground text-[13px]">
      ...
      <div className="shrink-0 border-b-2 border-border bg-card" style={{ height: '40%' }}>
        <div className="h-full flex flex-col p-6">
          ...
          <div className="flex items-center justify-between mb-4">
            <button onClick={() => navigate('/admin/courses')} className="flex items-center gap-2 text-[13px] text-muted-foreground hover:text-foreground transition-colors">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {sections.map(sec => {
                ...
                return (
                  <div
                    key={sec.id}
                    onClick={() => navigate(`/admin/courses/${courseId}/sections/${sec.id}`)}
